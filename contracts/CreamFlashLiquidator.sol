...
contract CreamFlashLiquidator is Ownable, FlashLoanReceiverBase {

    address public comptrollerAddress = 0x589DE0F0Ccf905477646599bb3E5C622C84cC0BA;
    ...
    address public crBNB = 0x1Ffe17B99b439bE0aFC831239dDECda2A790fF3A;
    ...
    function executeOperation(
        ...
        if (liquidationData.vTokenDebt == crBNB) {
        ...
        if (liquidationData.vTokenCollateral != crBNB) {
